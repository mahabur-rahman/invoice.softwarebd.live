  ...
  return (
    <div className="w-full h-full flex flex-col overflow-y-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 p-4">
        {[
          { title: "Sales Overview", color: "from-blue-400 to-blue-600" },
          { title: "Revenue Breakdown", color: "from-purple-400 to-purple-600" },
          { title: "Client Growth", color: "from-teal-400 to-teal-600" },
        ].map((chart, i) => (
          <div
            key={i}
          ...
          >
            ...
            <div
              className={`flex-1 bg-linear-to-r ${chart.color} rounded-lg opacity-70 animate-pulse`}
            ></div>
          </div>
        ))}
      </div>
